...
namespace KyGYS
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        {
            //#if DEBUG
            //            this.txtusername.Text = "简欧家具";
            //#endif


            //Ultra.Web.Core.Configuration.OptionConfig cfg = new Ultra.Web.Core.Configuration.OptionConfig(Ultra.Web.Core.Configuration.EnOptionConfigType.Optional);
            //string vlu = cfg.Get<string>("conn");

            //Response.Write(vlu + "<BR/>");
            if (!Page.IsPostBack)
            {
